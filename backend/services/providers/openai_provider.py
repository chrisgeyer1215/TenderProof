...
class OpenAIProvider(BaseAIProvider):
    ...
    def extract_atestado_from_images(self, images: List[bytes]) -> Dict[str, Any]:
        """Extrai informações de atestado usando GPT-4o Vision."""
        # Importar o analyzer existente para reutilizar os prompts
    ...
    def extract_edital_requirements(self, texto: str) -> List[Dict[str, Any]]:
        ...
        from services.ai_analyzer import ai_analyzer
        return ai_analyzer.extract_edital_requirements(texto)
